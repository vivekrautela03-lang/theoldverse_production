            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 pt-2">
              ...
              <div className="space-y-1">
                ...
                <div className="flex gap-3 pt-1">
                  ...
                  <a href="https://youtube.com/@The_oldverse" target="_blank" rel="noreferrer" className="text-oldverse-secondary hover:text-oldverse-accent transition-all hover:scale-105">
                    <svg className="h-4.5 w-4.5" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
