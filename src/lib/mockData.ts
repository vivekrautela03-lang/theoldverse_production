...
export const mockMediaItems: MediaItem[] = [
  ...
  },
  {
    ...
    type: "original",
    category: "Originals",
    description: "Some meetings are written. The rest are felt. Silent glances, golden moments—where hearts meet and time stands still. Song: Golden Brown by The Stranglers.",
    duration: "Coming Soon",
    rating: "0.0",
    posterUrl: "/silence_glances.jpg",
    bannerUrl: "/silence_glances.jpg",
    videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/Sintel.mp4",
    creatorId: "creator-love",
    creatorName: "Shivanshi",
    isTrending: false,
